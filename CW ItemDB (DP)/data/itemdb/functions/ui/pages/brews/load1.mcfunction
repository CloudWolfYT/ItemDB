...
execute if score #slot itemdb = .brews itemdb run data modify storage itemdb out.id set value "minecraft:lime_stained_glass_pane"
execute if score #slot itemdb > .brews itemdb run data modify storage itemdb out.id set value "minecraft:black_stained_glass_pane"
execute if score #slot itemdb >= .brews itemdb run data modify storage itemdb out.tag.display.Name set value '{"text":""}'
