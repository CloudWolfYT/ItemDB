item replace block ~ ~ ~ container.0 with knowledge_book{itemdb:{has_id:1b,id:0},display:{Name:'{"text":"Recipes","italic":false}'}}
item replace block ~ ~ ~ container.9 with brewing_stand{itemdb:{has_id:1b,id:0},display:{Name:'{"text":"Brews","italic":false}'},Enchantments:[{}]}
item replace block ~ ~ ~ container.18 with smithing_table{itemdb:{has_id:1b,id:0},display:{Name:'{"text":"Smiths","italic":false}'}}
...
item replace block ~ ~ ~ container.3 with black_stained_glass_pane{itemdb:{has_id:1b,id:0},display:{Name:'{"text":""}'}}
...
item replace block ~ ~ ~ container.12 with black_stained_glass_pane{itemdb:{has_id:1b,id:0},display:{Name:'{"text":""}'}}
...
item replace block ~ ~ ~ container.21 with black_stained_glass_pane{itemdb:{has_id:1b,id:0},display:{Name:'{"text":""}'}}
...
data modify block 69 2 69 Text1 set value '[{"text":"ID: ","italic":false},{"score":{"objective":"itemdb","name":"#temp"}},{"text":"-"},{"score":{"objective":"itemdb","name":"#temp1"}}]'
execute if score #temp itemdb > .brews itemdb run data modify block 69 2 69 Text1 set value '[{"text":"-----","italic":false}]'
...
execute if score #bool itemdb matches 1 if score #bool1 itemdb matches 0 run function itemdb:ui/pages/brews/save
function itemdb:ui/pages/brews/load1

scoreboard players set #bool itemdb 1
scoreboard players set @s itemdb_page 3