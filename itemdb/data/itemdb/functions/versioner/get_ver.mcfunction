execute store result score in itemdb run data get storage itemdb temp[-1].tag.id
...
execute store result score in itemdb run data get storage itemdb temp[-1].tag.version
