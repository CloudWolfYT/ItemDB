item replace block ~ ~ ~ container.0 with brewing_stand{itemdb:{has_id:1b,id:0},display:{Name:'{"text":"Brews","italic":false}'}}
item replace block ~ ~ ~ container.9 with smithing_table{itemdb:{has_id:1b,id:0},display:{Name:'{"text":"Smiths","italic":false}'},Enchantments:[{}]}
item replace block ~ ~ ~ container.18 with furnace{itemdb:{has_id:1b,id:0},display:{Name:'{"text":"Smelts","italic":false}'}}
