...
tellraw @s {"text":"  Exporting Items will overwrite \n  any awaiting imported items!\n  Are you sure you want to export?\n"}
tellraw @s {"text":"  Yes, export! ☑","clickEvent":{"action":"run_command","value":"/function itemdb:menu/items/export1"},"color":"#8aff8a"}
tellraw @s {"text":"  No, don\'t export! ☒","clickEvent":{"action":"run_command","value":"/function itemdb:menu/items/start"},"color":"#ff8c8a"}
