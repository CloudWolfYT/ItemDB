...
tellraw @s {"text":"  Are you sure you want to import?\n"}
#tellraw @s {"text":"  Yes, import with append! ☑","clickEvent":{"action":"run_command","value":"/function itemdb:menu/items/import1"},"color":"#8aff8a"}
tellraw @s {"text":"  Yes, import with overwrite! ☑","clickEvent":{"action":"run_command","value":"/function itemdb:menu/items/import2"},"color":"#8aff8a"}
tellraw @s {"text":"  No, don\'t import! ☒","clickEvent":{"action":"run_command","value":"/function itemdb:menu/items/start"},"color":"#ff8c8a"}
