execute if score out1 itemdb matches 0 run item replace block ~ ~ ~ container.15 with air
...
function itemdb:crafter/barrel/get_loop
...
function itemdb:crafter/barrel/set_slot_count
