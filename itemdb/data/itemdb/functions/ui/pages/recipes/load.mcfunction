item replace block ~ ~ ~ container.0 with crafting_table{has_id:1b,id:0,display:{Name:'{"text":"Custom Item Database","italic":false}'}}
item replace block ~ ~ ~ container.9 with knowledge_book{has_id:1b,id:0,display:{Name:'{"text":"Recipes","italic":false}'},Enchantments:[{}]}
item replace block ~ ~ ~ container.18 with brewing_stand{has_id:1b,id:0,display:{Name:'{"text":"Brews","italic":false}'}}
...
item replace block ~ ~ ~ container.6 with black_stained_glass_pane{has_id:1b,id:0,display:{Name:'{"text":""}'}}
...
item replace block ~ ~ ~ container.24 with black_stained_glass_pane{has_id:1b,id:0,display:{Name:'{"text":""}'}}
