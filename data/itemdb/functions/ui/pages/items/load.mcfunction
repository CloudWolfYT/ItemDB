item replace block ~ ~ ~ container.0 with grass_block{has_id:1b,id:0,display:{Name:'{"text":"View Vanilla IDs","italic":false}'}}
item replace block ~ ~ ~ container.9 with crafting_table{has_id:1b,id:0,display:{Name:'{"text":"Custom Item Database","italic":false}'},Enchantments:[{}]}
