execute if score #slot itemdb matches 21 run data modify storage itemdb in[0][2][2] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 20 run data modify storage itemdb in[0][2][1] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 19 run data modify storage itemdb in[0][2][0] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 12 run data modify storage itemdb in[0][1][2] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 11 run data modify storage itemdb in[0][1][1] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 10 run data modify storage itemdb in[0][1][0] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 3 run data modify storage itemdb in[0][0][2] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 2 run data modify storage itemdb in[0][0][1] set from storage itemdb temp[-1].tag.itemdb.id
execute if score #slot itemdb matches 1 run data modify storage itemdb in[0][0][0] set from storage itemdb temp[-1].tag.itemdb.id
