item replace block ~ ~ ~ container.0 with knowledge_book{has_id:1b,id:0,display:{Name:'{"text":"Recipes","italic":false}'}}
item replace block ~ ~ ~ container.9 with brewing_stand{has_id:1b,id:0,display:{Name:'{"text":"Brews","italic":false}'},Enchantments:[{}]}
item replace block ~ ~ ~ container.18 with smithing_table{has_id:1b,id:0,display:{Name:'{"text":"Smiths","italic":false}'}}
