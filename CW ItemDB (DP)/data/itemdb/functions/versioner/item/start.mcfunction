...
execute if score in itemdb matches 0 unless data storage itemdb temp.tag.itemdb.has_id as @e[type=armor_stand,tag=itemdb] run function itemdb:versioner/item/vanilla
